...
function messageComposerController($scope) {
    var that = this,
        ...
        _sendFx = function() {
            if (!angular.isDefined(that.rawmessage) || that.rawmessage == null || that.rawmessage == '') {
                return;
            }
            var _message = {
                id: 'sc' + Date.now(),
...
angular.module("angular-simple-chat.directives").run(["$templateCache", function($templateCache) {
